    ...
    return (
        <div className="grid place-items-center w-screen px-16 py-32 gap-10 grid-rows-[auto_auto_auto]">
            <motion.div className="flex flex-col items-center gap-2">
                <motion.h1 className="text-3xl font-sans text-center font-bold">Lorem ipsum <span className="bg-gradient-to-r from-blue-300 to-[#ddd] bg-clip-text text-transparent">dolor</span> sit amet.</motion.h1>
                <motion.h2 className="text-[#bbb] font-mono text-center">Consetectur adispicing elit.</motion.h2>
                <motion.button className="border-1 font-sans bg-[#fff] transition-all duration-300 ease-out hover:bg-[#dfdfdf] 
                mt-4 text-[#0a0a0a] rounded-full px-6 py-3 text-sm flex justify-center">Pre-order</motion.button>
            </motion.div>
            <motion.div className="flex flex-col items-center mt-10 font-sans gap-5">
                <motion.h2 className="font-sans font-bold text-2xl mb-1">Food</motion.h2>
                <motion.div className="flex flex-col items-center gap-2">
            ...
            <motion.div className="flex flex-col items-center gap-5">
                <motion.h2 className="font-sans font-bold text-2xl">Drink</motion.h2>
